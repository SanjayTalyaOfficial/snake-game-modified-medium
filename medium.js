...
function draw(){
    ...
    for( let i = 0; i < anothersnakex.length ; i++){
        ctx.fillStyle = ( i == 0 )? "red" : "black";
        ctx.fillRect(anothersnakex[i].x,anothersnakex[i].y,box,box);
        
        ctx.strokeStyle = "red";
        ctx.strokeRect(anothersnakex[i].x,anothersnakex[i].y,box,box);
    }
    
    for( let i = 0; i < anothersnakex1.length ; i++){
        ctx.fillStyle = ( i == 0 )? "red" : "black";
        ctx.fillRect(anothersnakex1[i].x,anothersnakex1[i].y,box,box);
        
        ctx.strokeStyle = "red";
        ctx.strokeRect(anothersnakex1[i].x,anothersnakex1[i].y,box,box);
    }

    for( let i = 0; i < anothersnakex2.length ; i++){
        ctx.fillStyle = ( i == 0 )? "red" : "black";
        ctx.fillRect(anothersnakex2[i].x,anothersnakex2[i].y,box,box);
        
        ctx.strokeStyle = "red";
        ctx.strokeRect(anothersnakex2[i].x,anothersnakex2[i].y,box,box);
    }

    for( let i = 0; i < anothersnakex3.length ; i++){
        ctx.fillStyle = ( i == 0 )? "red" : "black";
        ctx.fillRect(anothersnakex3[i].x,anothersnakex3[i].y,box,box);
        
        ctx.strokeStyle = "red";
        ctx.strokeRect(anothersnakex3[i].x,anothersnakex3[i].y,box,box);
    }
    
    for( let i = 0; i < anothersnakex4.length ; i++){
        ctx.fillStyle = ( i == 0 )? "red" : "black";
        ctx.fillRect(anothersnakex4[i].x,anothersnakex4[i].y,box,box);
        
        ctx.strokeStyle = "red";
        ctx.strokeRect(anothersnakex4[i].x,anothersnakex4[i].y,box,box);
    }
    
    for( let i = 0; i < anothersnakex5.length ; i++){
        ctx.fillStyle = ( i == 0 )? "red" : "black";
        ctx.fillRect(anothersnakex5[i].x,anothersnakex5[i].y,box,box);
        
        ctx.strokeStyle = "red";
        ctx.strokeRect(anothersnakex5[i].x,anothersnakex5[i].y,box,box);
    };
